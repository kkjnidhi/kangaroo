...
function draw() {
  ...
  if (gameState===PLAY){
    if(shrubsGroup.isTouching(kangaroo)){ score = score + 1; shrubsGroup.destroyEach(); }
    jungle.velocityX=-3
...
function spawnObstacles() {
  ...
  function reset(){ gameState = PLAY; gameOver.visible = false; restart.visible = false;
     kangaroo.visible = true; kangaroo.changeAnimation("running", kangaroo_running); 
  obstaclesGroup.destroyEach(); shrubsGroup.destroyEach(); score = 0; }